...
![Figure 1. Current (A) and Future (B) Distributions for Grape Coral and CoTS under a moderate emission scenario (SSP3-7.0). Moderate (50%-75%) to high (75%-100%) projected occurrence for CoTS is overlaid in yellow, highlighting areas where both species may overlap, and regions prone to CoTS outbreaks.](coral_maxent1.jpg)
